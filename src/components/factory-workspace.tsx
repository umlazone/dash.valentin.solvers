    ...
    <div className="factory-stack">
      ...
      <section className="factory-panel">
        ...
        <div className="settings-grid">
          ...
          <div className="setting-card" data-danger={Boolean(data.settings.kill_switch)}><span>Kill switch</span><strong>{data.settings.kill_switch ? "STOP" : "READY"}</strong><p>{data.settings.kill_switch ? "Bloqueo de emergencia activo. No sale nada aunque exista cola ready." : "Sin bloqueo de emergencia; siguen aplicando aprobación, modo live y publisher gate."}</p><button className="quiet-button" disabled={busy === "kill_switch"} onClick={() => setting("kill_switch", !data.settings.kill_switch)}>{data.settings.kill_switch ? "Reactivar" : "Detener"}</button></div>
